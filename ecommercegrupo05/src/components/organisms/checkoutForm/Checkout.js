...
<Typography variant="body2" color="text.secondary" align="center">
    {'Copyright © '}
    Es en serio! Necesitamos un nombre!
...
<ThemeProvider theme={theme}>
    ...
    <Paper variant="outlined" sx={{ my: { xs: 3, md: 6 }, p: { xs: 2, md: 3 } }}>
        ...
        {activeStep === steps.length ? (
            ...
            Su número de orden es #2001539. Hemos enviado los detalles de su pedido por correo electrónico, 
            ...
            <Box sx={{ display: 'flex', justifyContent: 'flex-end' }}>
                ...
                sx={{ mt: 3, ml: 1 }}
                >
                {activeStep === steps.length - 1 ? <BtnFinal /> : 'Siguiente'}
                </Button>
            </Box>
            </React.Fragment>
        )}

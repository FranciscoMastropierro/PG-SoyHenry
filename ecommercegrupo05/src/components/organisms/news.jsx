...
export default function News() {
    ...
    return (
        <div className={style.wrapper}>
            ...
            <h1 className={style.titulo}>Starlink en Colombia</h1>
            ...
            <h1 className={style.titulo}>Las ciudades inteligentes se abren paso en Colombia con Enel X</h1>
            <div className={style.containerNews}>
                <div>
            ...
            <h1 className={style.titulo}>Liga Master Flow de LOL: Leviatán es el campeón tras vencer a Boca por 3 a 0 en el polideportivo de San Lorenzo</h1>
            <div className={style.containerNews}>
                <div>
            ...
            <h1 className={style.titulo}>El país que busca profesionales altamente calificados y al que no es imposible migrar sin ciudadanía europea</h1>
            <div className={style.containerNews}>
                <div>
